...
1.查询服务器A和远程设备B的id（Syncthing 唯一标识，用于设备配对）(A:CF3ELJD-TY2TRJ6-DIJLG6Y-6JWIIWS-OOXFF4E-TFFACNM-OA7FFEG-2LZ4VA4   B:UIHJDGI-Y3VR7UR-UPB5CDX-4KDALX5-CT4E7IS-NDFGOGD-BYCLKVF-QKTKAQQ)
syncthing --device-id
2.配置服务器
